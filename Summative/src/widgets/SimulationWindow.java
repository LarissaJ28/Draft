...
public class SimulationWindow {
	...
	public static final String BALL2_TEXTURE_FILE = "./res/Ball2.png";
	 ...
	 * @return ball			the ball entity
	 */
	public Entity createBall2Entity(float radius, float x, float y, float z, 
			float vx, float vy, float mass, float e) {
		...
		Circle ball = new Circle(ball2Model, position, velocity, acceleration, rotation, scale, 
				mass, e, radius, BALL_STATIC_FRICTION, BALL_KINETIC_FRICTION);
