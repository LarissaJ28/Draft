...
public class GameScreen {
	...
	public static String PATH_BUTTON_TEXTURE_FILE = "./res/PathOn.png";
	public static String PATH_OFF_BUTTON_TEXTURE_FILE = "./res/PathOff.png";
	
	private Boolean stopPath =true;
	/**
