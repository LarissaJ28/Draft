...
public class Entity {
	...
	public Entity(Model model, Vector3f position, Vector3f velocity, Vector3f acceleration, 
			Vector3f rotation, float scale, float mass, float e, float staticFriction, float kineticFriction,String type) {
	...
	public Entity(Model model2, Vector3f position2, Vector3f rotation2, float scale2) {
